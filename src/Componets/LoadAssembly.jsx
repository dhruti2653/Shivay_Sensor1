        ...
        <div className='mt-14 '>
          ...
          <div className='w-full flex mt-7 lg:px-7 flex-col lg:flex-row lg:gap-10'>
            <div className='lg:w-1/2 space-y-4'>
              ...
              <p className='text-[17px]'>Shivay Sensor has excellent reputation in manufacturing and supplying Adhesive and Accessories. We also engaged in providing customized product as per need of customers. We have a complete line of adhesive accessories.</p>
