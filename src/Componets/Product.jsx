    ...
    return (
        <>
            <div className="container mt-20 mb-6 w-full">
                <div className="component-header">
                    <div className="px-5 lg:px-20 mb-11 lg:text-left">
                        ...
                        <p className="mt-10 text-[17px] text-[#898989] lg:pr-32">
                            At Rudrra Sensor, we ensure that our long list of customers will not have to compromise on quality. We design, develop, and supply high-standard load cells to various industries including Healthcare, Automotive, Aerospace, and more.
                        </p>
                    </div>
                </div>
                ...
                <Link
              to={"/product"}
                    className="text-white bg-[#3ebbe1] px-7 py-3  rounded-lg shadow-lg lg:ml-32">Show More</Link>
                </div>
            </div>
        </>
    );
